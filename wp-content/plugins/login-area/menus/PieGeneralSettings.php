  ...
  <div class="right_section">
    <div class="settings">
      <h2><?php _e("Settings",'piereg') ?></h2>
       ...
       <?php ?><fieldset style="display: none;" class="piereg_fieldset_area">
    		<legend><?php _e("URL Settings",'piereg') ?></legend>
             ...
             <div class="fields">
              ...
              <span class="quotation"><?php _e("This page must contain the Custom Register Login form short code.",'piereg') ?></span> 
            </div> 
             ...
             <div class="fields">
              ...
              <span class="quotation"><?php _e("This page must contain the Custom Register Registration form short code.",'piereg') ?></span> 
            </div> 
             ...
             <div class="fields">
              ...
              <span class="quotation"><?php _e("This page must contain the Custom Register Forgot Password form short code.",'piereg') ?></span> 
            </div>
            <div class="fields">
        ...
        <fieldset class="piereg_fieldset_area">
    		<legend><?php _e("After LOgin",'piereg') ?></legend>
            
            <div class="fields">
                <label for="alternate_logout_url"><?php _e("Login Redirect URL",'piereg') ?></label>
        ...
        <?php /*?><fieldset class="piereg_fieldset_area">
     	...
     	<?php ?><fieldset class="piereg_fieldset_area">
          ...
          <div class="fields">
           ...
           <div class="fields">
              ...
              <span class="quotation"><?php _e("Allow Custom Registerto Add header Footer on wp-login.php.",'piereg') ?></span>
           </div>
            <div class="fields">
              ...
              <span class="quotation"><?php _e("Set this to No if you would like to disable Custom Registerfrom outputting the form CSS.",'piereg') ?></span>
          	</div>
            ...
            <div class="fields">
                ...
                <span class="quotation"><?php _e("Warning: Turning off any script here may stop Custom Registerto work properly, please do it carefully!",'piereg') ?></span>
            </div>
            <script type="text/javascript">
				piereg(document).ready(function(){
					piereg("#outputjquery_ui_no").on("click",function(){
						var pr_confrimation = confirm("Warning: Turning off this script here can stop Custom Registerto work properly! Are you sure?");
						if(!pr_confrimation)
						{
        ...
        <div class="fields">
		  ...
		  else
		  {
			  ...
			  echo '<span class="quotation">'.__("Sorry, Custom Registerrequires PHP 5.0 or higher. Please deactivate Pie-Register","piereg").'</span>';
		  }
		  ?>
        </div>
        <div class="fields">
          ...
          <?php
			...
			else
			{
				...
				echo '<span class="quotation">'.__("Sorry, Custom Registerrequires MySQL 5.0 or higher. Please deactivate Pie-Register","piereg").'</span>';
			}
			?>
        ...
        <div class="fields">
		  ...
		  else
		  {
			  ...
			  echo '<span class="quotation">'.__("Sorry, Custom Registerrequires Wordpress 3.5 or higher. Please deactivate Pie-Register","piereg").'</span>';
		  }
		  ?>
        </div>
        <div class="fields">
        ...
        <div class="fields">
          <p><?php _e("Custom Register integrates with reCAPTCHA, a free CAPTCHA services that helps to digitize Books while Protecting your forms from spam bots. Read more about reCAPTCHA.",'piereg') ?></p>
...
<input type="submit" class="submit_btn" value=" <?php _e("Save Changes","piereg");?> " />
	...
	<?php /*?>	<h3><?php _e("Remove Settings",'piereg'); ?></h3>
        <div class="fields" >
