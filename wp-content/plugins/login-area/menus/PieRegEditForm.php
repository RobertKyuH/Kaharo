...
{
 $addurl = admin_url()."admin.php?page=pie-register&formid=".Totalforms();
header("location:$addurl");
echo "<script>document.location.href='$addurl'</script>";
exit;
  ...
  <div class="pie_wrap">
    ...
    <form method="post" id="formeditor">
            ...
            <div class="advance_options_fields">
              ...
              <div class="advance_fields">
                ...
                <div class="advance_fields">
					...
					<select id="set_user_role_" name="field[form][role]" >
				  		<?php
						global $wp_roles;
						...
						foreach($role as $key=>$value)
						{
							...
							echo ($data['form']['role'] == $key) ? ' selected="selected" ' : '';
      ...
      <fieldset>
        ...
        <div id="hint_1" class="fields_hint" style="left: 95%;top: 50%; z-index:2;"> <img src="<?php echo plugins_url('login-area'); ?>/images/left_arrow.jpg" width="45" height="26" align="left">
	...
	?>
	  ...
	  ?>
      <input type="hidden" name="formid" value="<?php echo $_GET['formid']>0?$_GET['formid']:Totalforms() ?>" />      <input type="submit" style="float: right;margin-right:85px;" class="button button-primary button-large" name="pie_form"  value="<?php _e("Save Changes",'piereg');?>">
    </form>
  </div>
  <div class="right_menu">

         <div id="hint_0" style="top: 135px;margin-left: -271px;position: fixed;float:right;" class="fields_hint"> <img src="<?php echo plugins_url('login-area'); ?>/images/right_arrow.jpg" width="45" height="26" align="right">
          <div class="hint_content">
            <h4><?php _e("Did You Know ?","piereg"); ?></h4>
...
{
 global $wpdb;
 $sql = "SELECT  count(*) FROM $wpdb->options  where option_name	like 'pie_fields%' and  option_name not in('pie_fields_default','pie_fields_meta')";


 $total = $wpdb->get_var( $sql)+1;
 return  $total;
}
?>
