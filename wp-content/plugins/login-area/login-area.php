<?php
/*
Plugin Name:       MusexPress Login Area
Plugin URI:        http://www.musegain.com/adobe-muse/login-area/
Description:       Create a Restricted Area with Muse and manage your subscribers with WordPress
Version:           2.1.1
Author:            MuseGain.com
Author URI:        http://www.musegain.com
License:           MuseGain.com
License URI:       http://www.musegain.com/terms-conditions-of-use/
Documentation URI: http://www.musexpress.net/login_area_documentation.php
	...
	class PieRegister extends PieReg_Base{
		...
		*/
		...
		function __construct()
		{
			...
			add_shortcode( 'custom_register_login',  array($this,'showLoginForm') );
			add_shortcode( 'custom_register_form',  array($this,'showForm') );
			add_shortcode( 'custom_register_profile', array($this,'showProfile') );
			add_shortcode( 'custom_register_forgot_password',  array($this,'showForgotPasswordForm') );
			add_shortcode( 'custom_register_renew_account',  array($this,'show_renew_account') );
			...
			//add_action( 'admin_enqueue_scripts' ,array($this,'pie_admin_menu_style_enqueu') );
                        add_action( 'admin_enqueue_scripts' ,array($this,'login_area_style') );
			////FRONT END SCRIPTS
		...
		function pie_admin_menu_style_enqueu(){
			...
			wp_enqueue_style( 'pie_menu_style_css' );
                ...
                function login_area_style(){
			wp_register_style( 'login_area_style', plugins_url("/css/login_area_style.css",__FILE__),false,'2.0', "all" );
			wp_enqueue_style( 'login_area_style' );
		}
		...
		function check_upgrade_remote()
		{
			...
			$plugin_current_version = '999999999999';
		...
		function pie_main()
		{
			...
			/*********************************************/
			/////////////// PIEREG LOGOUT ////////////////
			if( (isset($_GET['piereg_logout_url']) and isset($_REQUEST['redirect_to'])) and ($_GET['piereg_logout_url'] == "true") ){
					...
					<div>
						...
						<div style="padding:15px 15px 0 15px;">
							<select id="pie_forms">
								...
								<option value="[custom_register_form]"><?php _e("Registration Form","piereg") ?></option>
								<option value="[custom_register_login]"><?php _e("Login Form","piereg") ?></option>
								<option value="[custom_register_forgot_password]"><?php _e("Forgot Password Form","piereg") ?></option>
								<option value="[custom_register_profile]"><?php _e("Profile Page","piereg") ?></option>
		...
		function AddPanel()
		{
			...
			$pie_page_suffix_1 = add_object_page( "Pie Register", __('Login Area',"piereg"), 'manage_options', 'form-register',  array($this,'RegistrationForms'), plugins_url("/images/pr_icon.png",__FILE__) );

			add_action('admin_print_scripts-' . $pie_page_suffix_1, array($this,'pieregister_admin_scripts_styles'));

$pie_page_suffix_2 = add_submenu_page( 'form-register', 'Registration Forms', __('Registration Forms',"piereg"), 'manage_options', 'form-register', array($this, 'RegistrationForms') );

			add_action('admin_print_scripts-' . $pie_page_suffix_2, array($this,'pieregister_admin_scripts_styles'));


			$pie_page_suffix_2 = add_submenu_page( 'form-register', 'Form Editor', __('Form Editor',"piereg"), 'manage_options', 'pie-register', array($this, 'RegPlusEditForm') );

			add_action('admin_print_scripts-' . $pie_page_suffix_2, array($this,'pieregister_admin_scripts_styles'));


			$pie_page_suffix_3 = add_submenu_page( 'form-register', 'General Settings', __('General Settings',"piereg"), 'manage_options', 'pie-general-settings', array($this, 'PieGeneralSettings') );
		...
		add_action('admin_print_scripts-' . $pie_page_suffix_3, array($this,'pieregister_admin_scripts_styles'));
			...
			$pie_page_suffix_5 = add_submenu_page( 'form-register', 'Email Notification Settings', __('Admin Notifications',"piereg"), 'manage_options', 'pie-admin-notification', array($this, 'PieRegAdminNotification') );

			add_action('admin_print_scripts-' . $pie_page_suffix_5, array($this,'pieregister_admin_scripts_styles'));

			$pie_page_suffix_6 = add_submenu_page( 'form-register', 'Email Notification Settings', __('User Notifications',"piereg"), 'manage_options', 'pie-user-notification', array($this, 'PieRegUserNotification') );
			...
			// help page
			$pie_page_suffix_9 = add_submenu_page( 'form-register', 'Help', __('Help',"piereg"), 'manage_options', 'pie-help', array($this, 'PieRegHelp'));
		...
		function saveFields()
		{
			...
			update_option("pie_fields".$_POST['formid'],serialize($updated_post));
		...
		{require_once($this->plugin_dir.'/menus/showvalues_register.php');
		}
		//Opening Form Editor
