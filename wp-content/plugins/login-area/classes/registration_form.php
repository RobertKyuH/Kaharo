...
class Registration_form extends PieReg_Base
{
	...
	function addFormData()
	{
		...
		//$data .= '<span><input type="text" name="role" value="'.$this->data['form']['role'].'" /></span>';		
		$data .= '</div>';
		return $data;
	...
	function printFields($fromwidget = false)
	{
		...
		//print_r($this->data);
		$pie_reg_fields .='<span><input type="hidden" name="role" value="'.$this->data['form']['role'].'"  autocomplete="off" /></span>';
