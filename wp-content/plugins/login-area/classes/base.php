...
class PieReg_Base
{
	...
	{	  $id = $_GET['formid']>0?$_GET['formid']:"";
		$data 	= get_option("pie_fields$id");
	...
	function install_settings()
	{
		...
		{
			$_p = array();
			$_p['post_title'] 		= __("Custom Register - Login","piereg");
			$_p['post_content'] 	= "[custom_register_login]";
		...
		{
			$_p = array();
			$_p['post_title'] 		= __("Custom Register - Registration","piereg");
			$_p['post_content'] 	= "[custom_register_form]";
			$_p['post_status'] 		= 'publish';
			$_p['post_type'] 		= 'page';
			$_p['comment_status'] 	= 'closed';
			$_p['ping_status'] 		= 'closed';
		...
		{
			$_p = array();
			$_p['post_title'] 		= __("Custom Register - Forgot Password","piereg");
			$_p['post_content'] 	= "[custom_register_forgot_password]";
			$_p['post_status'] 		= 'publish';
			$_p['post_type'] 		= 'page';
			$_p['comment_status'] 	= 'closed';
			$_p['ping_status'] 		= 'closed';
		...
		{
			$_p = array();
			$_p['post_title'] 		= __("Custom Register - Profile","piereg");
			$_p['post_content'] 	= "[custom_register_profile]";
			$_p['post_status'] 		= 'publish';
			$_p['post_type'] 		= 'page';
			$_p['comment_status'] 	= 'closed';
			$_p['ping_status'] 		= 'closed';
		...
		$update['redirect_user']			= ($current['redirect_user'])?$current['redirect_user']:0;
		...
		$update['show_admin_bar']			= ($current['show_admin_bar'])?$current['show_admin_bar']:0;
	...
	{ //Show warning if plugin is installed on a WordPress lower than 3.2
		...
		//VERSION CONTROL
		if( $wp_version < 3.5 )
		echo "<div id='piereg-warning' class='updated fade-ff0000'><p><strong>".__('Custom-Register is only compatible with WordPress v3.5 and up. You are currently using WordPress.', 'piereg').$wp_version.". ".__("The plugin may not work as expected.","piereg")."</strong> </p></div>";
	}
