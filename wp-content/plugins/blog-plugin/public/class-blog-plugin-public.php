...
class Blog_Plugin_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/blog-plugin-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/blog-plugin-public.js', array( 'jquery' ), $this->version, false );
	...
	public function redirect_blog_pages($template){
	...
	public function blog_archive_title($title){
